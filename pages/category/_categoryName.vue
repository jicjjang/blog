  ...
  export default {
    ...
    head () {
      return {
        title: 'June',
        meta: [
          {hid: 'og:title', name: 'og:title', content: this.categoryName || 'June'},
          {hid: 'og:url', name: 'og:url', content: `https://jicjjang.github.io/blog/${this.categoryName ? 'category/' + this.categoryName : ''}`},
